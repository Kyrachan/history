...
var serverAddress = 'http://83.212.114.31:99'; //switch to 90 for flask dev server 99 for gunicorn
...
var reloadHistoryFrequency = 888; //smaller means faster (every 888 frames check if history changed - about 2.2 mins in my machine)
...
function setup() {
  ...
  var lastWordAddress = serverAddress.concat("/lastWordJS/");
